...
private:
    ...
    // ========Action=========
    void Action_TA(const Turnaround& turnaround);
    void Action(std::variant<Flight, Bus, GroundDuty>& candidate_task);
    ...
    // ========Check State=========
    bool Check_Action_validity(const Turnaround& candidate_turnaround);
    // Ground Duty Check
